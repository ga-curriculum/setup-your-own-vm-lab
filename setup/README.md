<h1>
  <span class="headline">Setup Your Own VM Lab Lab</span>
...
Create a new markdown file named <code class="filepath">create-a-vm.md</code>:
...
Open the <code class="filepath">create-a-vm.md</code> file in VS Code and add the following content:
...
You may want to quickly get up to speed on markdown text syntax by going through [this tutorial](https://commonmark.org/help/tutorial/) before you begin or reference it as you go. Don't worry; you'll mostly write plain text in the <code class="filepath">create-a-vm.md</code> file.
